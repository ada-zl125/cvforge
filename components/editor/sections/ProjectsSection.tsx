        ...
        <div className="border-t border-border px-3 pb-3 pt-2">
          ...
          <div className="grid grid-cols-2 gap-x-3 gap-y-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <Input value={proj.startDate} onChange={(e) => onUpdate("startDate", e.target.value)} placeholder={defaultDate(language, -4)} />
            </div>
            <div className="flex flex-col gap-1">
              <Label className="text-xs">{zh ? "结束时间" : "End Date"}</Label>
              <Input value={proj.endDate} onChange={(e) => onUpdate("endDate", e.target.value)} placeholder={defaultDate(language)} />
            </div>
          </div>
