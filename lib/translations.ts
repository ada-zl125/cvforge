...
const t = {
  en: {
    ...
    saveName: "Save name",
    emailManagedByGoogle: "Your email is managed by Google and cannot be changed here.",
    changeEmailLabel: "Change email",
    currentEmail: (email: string) => `Current: ${email}`,
    updateEmail: "Update email",
    emailConfirmSent: (email: string) => `A confirmation link has been sent to ${email}. Click it to complete the change.`,
    changePasswordLabel: "Change password",
    newPasswordLabel: "New password",
    confirmPasswordLabel2: "Confirm password",
  ...
  zh: {
    ...
    displayNameTooLong: "最多 50 个字符",
    displayNameUpdated: "显示名称已更新。",
    saveName: "保存名称",
    emailManagedByGoogle: "你的邮箱由 Google 管理，无法在此更改。",
    changeEmailLabel: "更换邮箱",
    currentEmail: (email: string) => `当前：${email}`,
    updateEmail: "更新邮箱",
    emailConfirmSent: (email: string) => `确认链接已发送至 ${email}，点击链接完成更换。`,
    changePasswordLabel: "修改密码",
    newPasswordLabel: "新密码",
    confirmPasswordLabel2: "确认密码",
